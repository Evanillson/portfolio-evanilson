    ...
    <div className="pt-24 pb-16">
      <div className="max-w-5xl mx-auto px-6">
        <motion.nav
          ...
          style={{ color: 'var(--foreground-muted)' }}
        >
          <Link href="/" className="hover:text-[var(--accent-primary)] transition-colors duration-300">Home</Link>
          <ChevronRight size={14} />
          <Link href="/projetos" className="hover:text-[var(--accent-primary)] transition-colors duration-300">Projetos</Link>
          <ChevronRight size={14} />
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight mb-4" style={{ color: 'var(--foreground)' }}>
            {project.title}
          </h1>
        ...
        >
          {project.tags.map((tag) => (
            <span
              ...
              style={{ background: 'var(--card-bg)', border: '1px solid var(--card-border)', color: 'var(--accent-primary)' }}
            >
              {tag}
            </span>
          ))}
        ...
        >
          <button
            ...
            style={{ background: 'var(--card-bg)', backdropFilter: 'blur(8px)', border: '1px solid var(--card-border)', color: 'var(--foreground)' }}
          ...
          <div className="aspect-video relative">
            {project.embedUrl ? (
              ...
              <div className="w-full h-full relative">
                <Image src="/dashboard_placeholder.png" alt="Dashboard Placeholder" fill className="object-cover" />
          ...
          <div className="flex sm:hidden items-center gap-2 px-4 py-3 text-xs" style={{ borderTop: '1px solid var(--divider)', color: 'var(--foreground-muted)' }}>
            <Smartphone size={14} />
